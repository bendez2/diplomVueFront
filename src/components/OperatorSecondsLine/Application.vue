                    ...
                    <v-window v-model="tab">
                        <v-window-item value="one">
                            <v-row style="padding-top: 15px">
                                <v-col>
                                    <v-autocomplete v-model="application.initiator_id" :items="initiatorsApp"
                                ...
                                <v-col>
                                    <v-autocomplete readonly v-model="application.status_id" :items="statusesApp"
                                        ...
                                        variant="outlined"></v-autocomplete>
                                    <v-autocomplete readonly v-model="application.employee_id" :items="empl" item-value="id"
                        ...
                        <v-window-item value="two">
                            <v-col>
                                <v-row>
                                    <v-col>
                                        <v-autocomplete learable v-model="nameTypeApp" label="Тип" item-title="name"
                                            item-value="id" :items="nameApps" variant="outlined"></v-autocomplete>
                                    </v-col>
                                    <v-col>
                                        <v-autocomplete learable v-model="priorityTypeApp" label="Приоритет"
